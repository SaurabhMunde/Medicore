...
<ul>
	...
	<li> <a href="drugs.html"><div class="icon"><i class="fa fa-medkit" aria-hidden="true"></i>
...
$search_variable = $_POST["condition"];

if($search_variable == NULL)
	echo "empty";
else
{
	$query = "SELECT * FROM medicine WHERE Uses Like '%$search_variable%'";
